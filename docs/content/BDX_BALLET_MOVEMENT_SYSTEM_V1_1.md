...
1. [この資料の目的](#1-この資料の目的)
2. [BDXにおけるバレエ動作の考え方](#2-bdxにおけるバレエ動作の考え方)
3. [この資料の使い方](#3-この資料の使い方)
...
12. [動作発展図](#12-動作発展図)
13. [初心者向け難易度調整](#13-初心者向け難易度調整)
14. [身体部位・動きの特徴から探す](#14-身体部位・動きの特徴から探す)
15. [コンテンツ制作での使い方](#15-コンテンツ制作での使い方)

---

## 1. この資料の目的

本資料は、BDXプロダクト設計者と鈴ちゃんが、MOVEコンテンツを企画・構成するときに一緒に開いて使う実務資料である。バレエ用語を網羅する教科書ではなく、バレエ動作を一般ユーザーの身体づくりへ応用するための制作ツールとして扱う。

この資料から、短時間で次の判断ができる状態を目指す。

- どのような動作があるか
- 主にどの身体部位を使うか
- その場、移動、片脚支持、ジャンプ、回転等の特徴があるか
- 初心者向けにどう調整できるか
- 何と組み合わせ、次に何へ発展できるか
- 制作時にどの安全上の注意を確認するか
...
動作体系がないままMOVEを増やすと、候補の探し方、難易度の決め方、前提動作、組み合わせ方が制作ごとに分断される。

| 制作時の迷い | 本資料で確認する場所 |
|---|---|
| 何を使えばよいか分からない | 身体部位・動きの特徴から探す |
| 動作の違いを比較できない | 各レベルの動作一覧 |
| 初心者向けにどう変えるか分からない | 発展と注意点／初心者向け難易度調整 |
| 何と組み合わせられるか分からない | 組み合わせ・発展／動作発展図 |
| 誰が何を確認するか曖昧 | コンテンツ制作での使い方／専門監修チェック項目 |

アプリ機能、推薦ロジック、データベース設計、将来ロードマップは本資料に含めず、必要になった時に別資料として扱う。
...
各動作は、MOVE制作時に候補を比較できるよう、動作概要、主に使う部位、動きの特徴を表示する。
...
| 動作名 | 動作概要 | 主に使う部位 | 動きの特徴 |
|---|---|---|---|
| デミ・プリエ | 両脚で支持し、姿勢を保ちながら膝と股関節を曲げ伸ばす | 下半身、股関節、膝関節、足関節、体幹 | その場／両脚／低衝撃／バランス要求：低／協調性要求：中 |
| グラン・プリエ | より大きな可動域で沈み、立位へ戻る | 下半身、股関節、膝関節、足関節、体幹 | その場／両脚／低衝撃／バランス要求：中／協調性要求：中 |
| バットマン・タンデュ | 支持脚を保ち、足先を床から離さず一方向へ伸ばして戻す | 下半身、股関節、足関節、足部、体幹 | その場／片脚中心／低衝撃／バランス要求：中／協調性要求：中 |
| デガジェ | バットマン・タンデュから足先を床面より離して素早く出し戻す | 下半身、股関節、足関節、体幹 | その場／片脚中心／低衝撃／バランス要求：中／協調性要求：中 |
| ルルヴェ | 足裏全体の支持から踵を上げ、軸を保って戻す | 下半身、足関節、足部、ふくらはぎ、体幹 | その場／両脚または片脚／低衝撃／バランス要求：中／協調性要求：中 |
| ポール・ド・ブラ | 姿勢と呼吸を保ちながら腕を滑らかに運ぶ | 上半身、肩周辺、腕、体幹 | その場／両脚／低衝撃／バランス要求：低／協調性要求：中 |
| カンブレ | 軸を失わない範囲で上体を前後または側方へ動かす | 体幹、上半身、股関節 | その場／両脚／低衝撃／バランス要求：中／協調性要求：中 |
| エポールマン | 肩、頭、視線と身体の方向を協調させる | 上半身、肩周辺、首周辺、体幹 | その場／両脚または片脚／低衝撃／バランス要求：中／協調性要求：高 |

### 発展と注意点

| 動作名 | 前提となる動作 | 初心者向け調整 | 組み合わせ・発展 | 安全上の注意 |
|---|---|---|---|---|
...
| 動作名 | 動作概要 | 主に使う部位 | 動きの特徴 |
|---|---|---|---|
| ロン・ド・ジャンブ・ア・テール | 足先で床上に弧を描き、股関節から脚の方向を変える | 下半身、股関節、足関節、体幹 | その場／片脚中心／低衝撃／バランス要求：中／協調性要求：中 |
| フォンデュ | 支持脚と動脚を協調させて曲げ、伸ばす | 下半身、股関節、膝関節、足関節、体幹 | その場／片脚中心／低衝撃／バランス要求：高／協調性要求：高 |
| フラッペ | 動脚を素早く伸ばし、明確に出し戻す | 下半身、股関節、足関節、足部、体幹 | その場／片脚中心／低衝撃／バランス要求：中／協調性要求：高 |
| プティ・バットマン | 膝の位置を保ち、下腿を細かく切り替える | 下半身、股関節、膝関節、足関節、体幹 | その場／片脚中心／低衝撃／バランス要求：高／協調性要求：高 |
| パッセ | 片脚を支持脚の近くに通過させて運ぶ | 下半身、股関節、膝関節、体幹 | その場／片脚中心／低衝撃／バランス要求：中／協調性要求：中 |
| ルティレ | 片脚を支持脚の膝付近に保持する | 下半身、股関節、膝関節、体幹 | その場／片脚／低衝撃／バランス要求：高／協調性要求：高 |
| デヴェロッペ | 曲げた動脚をコントロールしながら一方向へ伸ばす | 下半身、股関節、体幹 | その場／片脚／低衝撃／バランス要求：高／協調性要求：高 |
| グラン・バットマン | 動脚を大きく振り上げ、制御して戻す | 下半身、股関節、体幹 | その場／片脚中心／中衝撃／バランス要求：高／協調性要求：高 |
| ロン・ド・ジャンブ・アン・レール | 動脚を空中に保ち、下腿または脚で弧を描く | 下半身、股関節、膝関節、体幹 | その場／片脚／低衝撃／バランス要求：高／協調性要求：高 |
| ロン・ド・ジャンブ・ジュテ | 脚を投げ出すような動きと弧の方向変化を組み合わせる | 下半身、股関節、足関節、体幹 | その場／片脚中心／中衝撃／バランス要求：高／協調性要求：高 |
...
| 動作名 | 動作概要 | 主に使う部位 | 動きの特徴 |
|---|---|---|---|
| アラベスク | 片脚支持で反対脚を後方へ伸ばし、全身のラインを保つ | 下半身、股関節、体幹、上半身 | その場／片脚／低衝撃／バランス要求：高／協調性要求：高 |
| アティテュード | 片脚支持で動脚を曲げた形に保ち、姿勢を維持する | 下半身、股関節、体幹、上半身 | その場／片脚／低衝撃／バランス要求：高／協調性要求：高 |
| アラベスク・パンシェ | アラベスクから上体と動脚のラインを傾ける | 下半身、股関節、体幹、上半身 | その場／片脚／低衝撃／バランス要求：高／協調性要求：高 |
| ルルヴェ・パッセ | ルルヴェ上で片脚をパッセまたはルティレの位置に保つ | 下半身、股関節、足関節、足部、体幹 | その場／片脚／低衝撃／バランス要求：高／協調性要求：高 |
| ルルヴェ・アラベスク | ルルヴェ上でアラベスクのラインを保つ | 下半身、股関節、足関節、足部、体幹 | その場／片脚／低衝撃／バランス要求：高／協調性要求：高 |
| デヴェロッペ・ア・ラ・スゴンド | デヴェロッペで動脚を側方へ伸ばし保持する | 下半身、股関節、体幹、上半身 | その場／片脚／低衝撃／バランス要求：高／協調性要求：高 |
...
| 動作名 | 動作概要 | 主に使う部位 | 動きの特徴 |
|---|---|---|---|
| タン・リエ | 脚を伸ばす動作と体重移動をつなぎ、支持脚を乗り換える | 下半身、股関節、膝関節、足関節、体幹 | 移動／支持切替／低衝撃／バランス要求：中／協調性要求：高 |
| トンベ | 一方向へ重心を落とし、新しい支持脚へ移る | 下半身、股関節、膝関節、足関節、体幹 | 移動／片脚から片脚／低〜中衝撃／バランス要求：中／協調性要求：高 |
| パ・ド・ブレ | 小さなステップを連続し、重心と方向を移す | 下半身、足関節、足部、体幹 | 移動／支持切替／低衝撃／バランス要求：中／協調性要求：高 |
| シャッセ | 一方の脚が他方を追うように移動する | 下半身、股関節、膝関節、足関節、体幹 | 移動／支持切替／低〜中衝撃／小さな浮き／バランス要求：中／協調性要求：高 |
| バランセ | 左右または前後へ揺れるように重心を移す | 下半身、股関節、足関節、体幹、上半身 | 移動／支持切替／低衝撃／バランス要求：中／協調性要求：高 |
| グリッサード | 床を滑るように脚を開閉して移動する | 下半身、股関節、膝関節、足関節、体幹 | 移動／支持切替／中衝撃／小ジャンプ／バランス要求：高／協調性要求：高 |
| ピケ | 伸ばした脚へ踏み込み、明確に重心を乗せる | 下半身、足関節、足部、体幹 | 移動／片脚／低〜中衝撃／バランス要求：高／協調性要求：高 |
| パ・ド・バスク | 方向と支持脚を変えながら弧を描くように移動する | 下半身、股関節、足関節、体幹、上半身 | 移動／支持切替／中衝撃／方向転換あり／小さな浮き／バランス要求：高／協調性要求：高 |
...
| 動作名 | 動作概要 | 主に使う部位 | 動きの特徴 |
|---|---|---|---|
| ソテ | 両脚または片脚で床を押し、同じ支持構造へ着地する | 下半身、股関節、膝関節、足関節、体幹 | その場／両脚または片脚／中衝撃／ジャンプあり／バランス要求：中／協調性要求：高 |
| シャンジュマン | 跳躍中に脚の前後関係を入れ替えて着地する | 下半身、股関節、膝関節、足関節、体幹 | その場／両脚／中衝撃／ジャンプあり／バランス要求：高／協調性要求：高 |
| エシャッペ・ソテ | 閉じた脚位から跳び、開いた脚位へ移って戻る | 下半身、股関節、膝関節、足関節、体幹 | その場／両脚／中衝撃／ジャンプあり／バランス要求：高／協調性要求：高 |
| アッサンブレ | 一方の脚から跳び、空中で脚を集めて両脚で着地する | 下半身、股関節、膝関節、足関節、体幹 | 移動／片脚から両脚／中〜高衝撃／ジャンプあり／バランス要求：高／協調性要求：高 |
| ジュテ | 一方の脚から他方の脚へ跳び移る | 下半身、股関節、膝関節、足関節、体幹 | 移動／片脚から片脚／中〜高衝撃／ジャンプあり／バランス要求：高／協調性要求：高 |
| シソンヌ | 両脚から跳び、主に片脚へ着地する | 下半身、股関節、膝関節、足関節、体幹 | 移動／両脚から片脚／高衝撃／ジャンプあり／バランス要求：高／協調性要求：高 |
| パ・ド・シャ | 脚を順に引き上げながら空中を移動する | 下半身、股関節、膝関節、足関節、体幹 | 移動／片脚から片脚／高衝撃／ジャンプあり／バランス要求：高／協調性要求：高 |
| アントルシャ・カトル | 空中で脚を素早く交差させ、両脚で着地する | 下半身、股関節、膝関節、足関節、体幹 | その場／両脚／高衝撃／ジャンプあり／バランス要求：高／協調性要求：高 |
| ブリゼ | 移動する跳躍の中で脚を打ち合わせる | 全身、下半身、股関節、膝関節、足関節、体幹 | 移動／片脚から片脚／高衝撃／方向転換あり／ジャンプあり／バランス要求：高／協調性要求：高 |
| グラン・ジュテ | 大きく空間を移動し、一方の脚から他方へ跳ぶ | 全身、下半身、股関節、膝関節、足関節、体幹 | 移動／片脚から片脚／高衝撃／ジャンプあり／バランス要求：高／協調性要求：高 |
...
| 動作名 | 動作概要 | 主に使う部位 | 動きの特徴 |
|---|---|---|---|
| ストゥニュー・ターン | 両脚をまとめる動きと方向転換を連続させる | 下半身、足関節、足部、体幹、上半身 | 移動／両脚中心／低衝撃／回転あり／バランス要求：高／協調性要求：高 |
| シェネ | 小さなステップを連続しながら回転して移動する | 全身、下半身、足関節、足部、体幹 | 移動／支持切替／低〜中衝撃／連続回転／バランス要求：高／協調性要求：高 |
| ピケ・ターン | 伸ばした脚へ踏み込み、片脚支持で回転する | 下半身、股関節、足関節、足部、体幹 | 移動／片脚／低〜中衝撃／回転あり／バランス要求：高／協調性要求：高 |
| ピルエット・アン・ドゥオール | 片脚支持で身体を外方向へ回転させる | 全身、下半身、股関節、足関節、体幹 | その場／片脚／低衝撃／回転あり／バランス要求：高／協調性要求：高 |
| ピルエット・アン・ドゥダン | 片脚支持で身体を内方向へ回転させる | 全身、下半身、股関節、足関節、体幹 | その場／片脚／低衝撃／回転あり／バランス要求：高／協調性要求：高 |
| アティテュード・ターン | アティテュードの形を保ちながら片脚で回転する | 全身、下半身、股関節、足関節、体幹 | その場・移動／片脚／低衝撃／回転あり／バランス要求：高／協調性要求：高 |
| フェッテ | 動脚の運動と支持脚の回転を連続させる | 全身、下半身、股関節、膝関節、足関節、体幹 | その場／片脚／中衝撃／連続回転／バランス要求：高／協調性要求：高 |
...
| 動作名 | 動作概要 | 主に使う部位 | 動きの特徴 |
|---|---|---|---|
| アダージオ | ゆっくりしたテンポで、姿勢、バランス、脚のコントロールを連結する | 全身、下半身、上半身、股関節、体幹 | その場・移動／支持切替／低衝撃／回転あり／バランス要求：高／協調性要求：高 |
| プティ・アレグロ | 小さく速いジャンプやステップを連続させる | 全身、下半身、股関節、膝関節、足関節、体幹 | 移動／支持切替／中〜高衝撃／回転あり／ジャンプあり／バランス要求：高／協調性要求：高 |
| グラン・アレグロ | 大きな移動と跳躍を組み合わせる | 全身、下半身、上半身、股関節、膝関節、足関節、体幹 | 大きく移動／支持切替／高衝撃／回転あり／ジャンプあり／バランス要求：高／協調性要求：高 |
| アンシェヌマン | 目的に応じて複数の動作を一つの流れへ組み立てる | 全身、下半身、上半身、股関節、足関節、体幹 | その場・移動／支持切替／バランス要求：高／協調性要求：高 |
| マネージュ | 円形の軌道などを使い、移動、跳躍、回転を連続させる | 全身、下半身、上半身、股関節、膝関節、足関節、体幹 | 大きく移動／支持切替／中〜高衝撃／回転あり／ジャンプあり／バランス要求：高／協調性要求：高 |
...
> **索引の使い方**<br>
> 候補を見つけた後は、各レベルの「動作一覧」と「発展と注意点」で、前提、初心者向け調整、組み合わせ・発展、安全上の注意を確認する。索引だけで採用を決めない。
...
3. 動作一覧で、概要、使用部位、支持、衝撃、バランス、協調性を比較する。
4. 発展と注意点で、前提、初心者向け調整、組み合わせ、安全上の注意を確認する。
